              ...
              >
                {service.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <Badge variant="info" className="shadow-sm">Most Popular</Badge>
                  </div>
                )}
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Have a specific legal need? Our team can help with ad-hoc legal work,
                  international jurisdictions, or complex structures.
                </p>
              </div>
