...
export const mockServices = [
  {
    ...
    name: "Launch",
    price: 999,
    description: "Everything you need to incorporate and launch legally",
    features: [
      "Delaware C-Corp incorporation",
      "EIN registration",
      "Founder agreements (up to 4)",
  ...
  },
  {
    ...
    name: "Fund",
    price: 2499,
    description: "Raise your seed round with confidence",
    features: [
      "Everything in Launch",
      "SAFE note drafting (up to 5)",
      "Cap table modeling",
      "Investor NDA templates",
      "Term sheet review",
  ...
  },
  {
    ...
    name: "Scale",
    price: 4999,
    description: "Series A and beyond — full legal operations",
    features: [
      "Everything in Fund",
      "Series A documentation",
      "409A valuation coordination",
      "Employee option pool setup",
      "Board consent resolutions",
      "Ongoing legal counsel (10 hrs/mo)",
    ],
    popular: false,
    cta: "Contact Us",
  },
